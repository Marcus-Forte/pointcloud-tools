...
{
public:
    ProcessPointCloudClient(std::shared_ptr<Channel> channel) : stub_(ProcessPointCloud::NewStub(channel))
    {
    }
...
int main()
{
    ...
    ProcessPointCloudClient Process(grpc::CreateChannel(target_str, grpc::InsecureChannelCredentials()));
